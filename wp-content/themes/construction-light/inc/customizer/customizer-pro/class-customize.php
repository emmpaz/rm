	...
	public function sections( $manager ) {
		...
		$manager->add_section(
			new ConstructionLight_Customize_Section_Pro(
				...
				array(
					// 'title' => esc_html__('35% Off Use Coupon Code : NEW2023 Validity : DEC 29 - JAN 10', 'construction-light'),
					'pro_text' => esc_html__( 'Upgrade To Pro','construction-light' ),
					'pro_url'  => apply_filters('construction-light-pro-link', esc_url('https://sparklewpthemes.com/wordpress-themes/constructionlightpro/') ),
					'priority'  => -1,
				)
			)
		);
