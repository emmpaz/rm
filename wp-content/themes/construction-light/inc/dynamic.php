...
if (! function_exists('construction_light_dynamic_css')){
	...
	function construction_light_dynamic_css(){
        ...
        */
        ...
        wp_add_inline_style( 'agencybell-style', $construction_light_dynamic );
        wp_add_inline_style( 'constructionbell-style', $construction_light_dynamic );
        wp_add_inline_style( 'construction-choice-style', $construction_light_dynamic );
	}
}
