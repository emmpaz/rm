...
function construction_light_scripts() {
	...
	wp_enqueue_script( 'construction-light', get_template_directory_uri() . '/assets/js/construction-light.js', array('jquery','masonry', 'countdown-timer', 'jquery-ui-accordion'), true );
